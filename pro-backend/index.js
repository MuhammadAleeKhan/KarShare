            ...
            app.post("/addride",verifyToken,(req,res)=>{
                ...
                jwt.verify(req.token,'secretkey',(err,authData)=>{
                    if(err){
                        ...
                        mysqlconnec.query(sql,[emp.userid,emp.userregistcarid,emp.startlat,emp.startlng,emp.endlat,emp.endlng,emp.Starting_address,emp.End_adrress],(err,row,fields)=>{
                            if(!err){
